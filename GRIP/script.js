...
function sendMoney() {
  ...
  var textNode = document.createTextNode(
    `Successful transaction of Rs${enterAmount} is sent to recepient with Email-id ${enterName}@email.com on ${Date()}.`
  );
  ...
  if (enterAmount > 8000) {
    ...
    alert(
      `Successful Transaction !! Rs${enterAmount} is sent to ${enterName}@email.com.`
    );
